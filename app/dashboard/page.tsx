    ...
    return (
        <main className='pt-6 h-screen bg-one'>
            ...
            <div className='bg-one border border-three w-full fixed flex justify-center items-center px-5 md:px-10 lg:px-20 space-x-5 h-20 py-2'>
                <Image src="/happy.png" alt='user profile picture' className='rounded-full h-full' height={0} width={100} />
                ...
                <Image src="/more.png" alt="menu bar" className='h-full' height={0} width={100} />
            </div>
            {/* PANELS */}
